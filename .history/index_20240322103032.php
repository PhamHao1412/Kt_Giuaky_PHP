        ...
        if (!empty($employees)) {
          foreach ($employees as $employee) {
            ...
            if ($isAdmin) {
                ...
                echo "<a href='employee_delete.php?id=<?php echo $employee['Ma_Nv']; ?>' onclick="return confirm('Bạn có chắc chắn muốn xóa nhân viên này không?')">Xóa</a>
"; // Delete link with confirmation and employee ID
            }
            echo "</td>";
            echo "</tr>";
          }
